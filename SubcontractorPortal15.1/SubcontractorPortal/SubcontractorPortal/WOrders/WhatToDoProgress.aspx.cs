    ...
    public partial class WhatToDoProgress : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (WorkOrderID != null)
            {
                ...
                WorkOrder = WorkOrder.GetWorkOrderDetails(WorkOrderID, ref LookUpDictionary, true);
            ...
            */
            if (Page.IsPostBack && !Page.IsCallback)
            {
                ...
                if (!IsStaffMember)
                {
                    ...
                    //-- Send Authorisation Code to Owner
                    if (ActionWO == "6")
                    {

                    }
                    
                    //-- Confirm Authorisation number, save to docs, send attachment to client
                    if (ActionWO == "7")
                    {
