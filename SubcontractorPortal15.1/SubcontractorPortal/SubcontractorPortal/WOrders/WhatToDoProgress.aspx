<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WhatToDoProgress.aspx.cs" Inherits="SubcontractorPortal.WOrders.WhatToDoProgress" %>
                    ...
                    <ContentCollection>
                        <dx:ContentControl ID="ContentControl4" runat="server" SupportsDisabledAttribute="True">
                            ...
                            <table cellpadding="5" cellspacing="5">
                                ...
                                <tr>
                                    <td>2. Signed Subcontractor WHS Statement</td>
                                </tr>
                                <tr>
                                    <td>3. Compliance certification (If Required)</td>
                                </tr>
                                <tr>
                                    <td>4. Invoice with address/search code of this Work Order. Variations must be invoiced separately, based on their own Work Orders.</td>
                                </tr>
