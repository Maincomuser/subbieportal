...
{
    public partial class VariationPhotos : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            currentURL = "/WOrders/VariationPhotos.aspx?WOID=" + Request.QueryString["WOID"] + @"&OID=" + Request.QueryString["OID"] + @"&quoteID=" + Request.QueryString["quoteID"];            
            message = null;
            messageColor = "green";
            ...
            if (!IsStaffMember)
            {
                if (e.IsValid)
                {
                    ...
                    if (DA.UseDiskStorage)
                    {
                        ...
                        NewFileName = DA.SubcontractorPhotoAddToDatabaseFromDisk(Convert.ToInt32(OrderID), e.UploadedFile.FileName, WorkOrderID, QuoteID, Variation.VersionLabel + ". ");
