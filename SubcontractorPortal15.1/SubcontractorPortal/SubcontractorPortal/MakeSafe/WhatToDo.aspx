<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WhatToDo.aspx.cs" Inherits="SubcontractorPortal.MakeSafe.WhatToDo" %>
...
<body>
    ...
    <center>
        <table cellpadding="5" cellspacing="5">
            <tr>
                <td class="status"><%=OrderType%> WO Status: <%=WOStatus %></td>
            </tr>
            <tr>
                        ...
                        <dx:ContentControl ID="ContentControl1" runat="server" SupportsDisabledAttribute="True">
                            ...
                            <table cellpadding="5" cellspacing="5">
                                <tr>
                                    ...
                                    <td align="left"><b>within 1 hour of this WO received and have arranged your work time on site.</b>
                                    </td>
                                </tr>
                                <tr>                                    
                                    <td>&nbsp;</td>
                            ...
                            <table cellpadding="5" cellspacing="5">
                                <tr>
                                    ...
                                    <td>2.</td>
                                    <td><b>You agree to sign Subcontractor Risk Assessment</b></td>
                                    <td></td>
                                </tr>
                            </table>
                            <table cellpadding="5" cellspacing="5">
                                <tr>
                                    ...
                                    <td align="left">
                                        <dx:ASPxDateEdit ID="WOStart" runat="server" HorizontalAlign="Left" Width="100" ClientInstanceName="e1" ReadOnly="True">
                                               <ClientSideEvents ValueChanged="OnValueChanged" />
                                        </dx:ASPxDateEdit>
                                    </td>
                                    <td align="right">End Date</td>
                                    <td align="left">
                                        <dx:ASPxDateEdit ID="WOFinish" runat="server" HorizontalAlign="Left" Width="100" ClientInstanceName="e2" ReadOnly="True">
                                               <ClientSideEvents ValueChanged="OnValueChanged" />
                                        </dx:ASPxDateEdit>
                                    </td>
                                </tr>
