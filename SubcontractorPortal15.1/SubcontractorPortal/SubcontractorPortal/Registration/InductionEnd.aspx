<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InductionEnd.aspx.cs" Inherits="SubcontractorPortal.Registration.InductionEnd" %>
...
<body style="background-color:#009FCE;">
    ...
    <form id="form1" runat="server">
        ...
        <table align="center">
            ...
            <tr>
                ...
                <td class="LMFontTop">                    
                    Your online induction is completed</td>
            </tr>
    ...
    <table width="100%" cellspacing="7">
        <tr>
            <td class="LMFont">                    
                        Thank for completing The Maincom Group Induction session.
                        <br />
                        <br />
                        The Maincom Group will now review your application.
                        <br />
                        <br />
                        If successful, The Maincom Group will contact you to arrange a Subbie Portal Training session that will be delivered to your group as an On-line Meeting via your computer.
                        <br />
                        <br />
                        Further details of this will provided upon approval of your applications. 
                        <br />
                        <br />
                        Kind Regards,
                        <br />
