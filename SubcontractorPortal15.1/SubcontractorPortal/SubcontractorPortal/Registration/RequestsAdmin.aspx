<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RequestsAdmin.aspx.cs" Inherits="SubcontractorPortal.Registration.RequestsAdmin" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function ShowLoginWindow(pDocTypeId) {
...
<body>
    <form id="form1" runat="server">
        <div style="width:95%; margin: 0 auto;">
            <br/>
            <dx:ASPxLabel ID="Lbl_Header" ClientInstanceName="Lbl_Header"  Text="Select a request from the list to view and work with it."  runat="server" Font-Size="Medium"></dx:ASPxLabel>
            <dx:ASPxGridView ID="gv_allrequests" runat="server" AutoGenerateColumns="False"  DataSourceID="sqlDS_requests" KeyFieldName="request_id" Width="100%" OnHtmlDataCellPrepared="gv_allrequests_HtmlDataCellPrepared">
                <Columns>
                    <dx:GridViewDataTextColumn Width="80px" ShowInCustomizationForm="True" VisibleIndex="0">
                        <DataItemTemplate>
                            <asp:LinkButton ID="btn_EditDocument" runat="server" OnClick="Btn_EditDocument_Click">Load</asp:LinkButton>
                        </DataItemTemplate>
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn Width="80px" ShowInCustomizationForm="True" VisibleIndex="1" FieldName="approval" Caption="ACTIONS">
                        <DataItemTemplate>
                            <asp:LinkButton ID="btn_ApproveReq" runat="server" OnClick="btn_ApproveReq_Click" OnClientClick="return confirm('A standad email will be sent to the Subcontractor asking them to complete their company details  (PART 2) \n \n ARE YOU SURE YOU WANT TO GO AHEAD?')">Pre Approve</asp:LinkButton>
                            <asp:LinkButton ID="btn_FinalApproveReq" runat="server" OnClick="btn_FinalApproveReq_Click"  OnClientClick="return confirm('A standad email will be sent to the Subcontractor letting them know they were Fully Approved and a welcome package email will be sent to them later on by the Maincom team. \n \n ARE YOU SURE YOU WANT TO CONTINUE?')">Approve</asp:LinkButton>
                            <asp:LinkButton ID="btn_RejectReq" runat="server"  OnClick="btn_RejectReq_Click" OnClientClick="return confirm('A standad email will be sent to the Subcontractor letting them know that they do not meet MAINCOM requirements at this stage.\n \n ARE YOU SURE YOU WANT TO CONTINUE?')">Reject</asp:LinkButton>
                            <asp:LinkButton ID="btn_MigrateSubbie" runat="server"  OnClick="btn_MigrateSubbie_Click" OnClientClick="return confirm('You are about to create a NEW SUBCONTRACTOR in the visionary system.\n \n DO YOU WANT TO CONTINUE?')">Migrate to Visionary</asp:LinkButton>
                        </DataItemTemplate>
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="request_id" Width="60px" ReadOnly="True" VisibleIndex="2" Caption="REQUEST ID">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="company_name" VisibleIndex="2" Caption="COMPANY NAME">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="company_email_address" VisibleIndex="3" Caption="E-MAIL">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="trade_skills" ReadOnly="True" VisibleIndex="4" Caption="SKILLS">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataDateColumn FieldName="request_date" VisibleIndex="5" Settings-AllowHeaderFilter="True" Settings-HeaderFilterMode="CheckedList" Caption="DATE CREATED">
                        <Settings AllowHeaderFilter="True" HeaderFilterMode="CheckedList"></Settings>
                    </dx:GridViewDataDateColumn>
                    <dx:GridViewDataTextColumn FieldName="request_state" VisibleIndex="6" Settings-AllowHeaderFilter="True" Settings-HeaderFilterMode="CheckedList" Caption="STATE">
                        <Settings AllowHeaderFilter="True" HeaderFilterMode="CheckedList"></Settings>
                    </dx:GridViewDataTextColumn>
                </Columns>
            ...
            <asp:SqlDataSource ID="sqlDS_requests" runat="server" ConnectionString="<%$ ConnectionStrings:DataConnectionString %>"
                SelectCommand="select c.request_id,
                               c.company_name,
                               c.company_email_address, 
                               dbo.SUBCONREG_RequestTradeSkills(c.request_id) trade_skills, 
                               r.request_date,
                               r.request_state
                         from  subconreg_companies c,
                               subconreg_requests r
                        where  r.request_id = c.request_id order by r.request_date desc"></asp:SqlDataSource>

            <div style="width: 99%;">
                <dx:ASPxLabel ID="Lbl_RequestId" ClientInstanceName="Lbl_RequestId" runat="server" Style="float: right;"></dx:ASPxLabel>
                <br />
                <dx:ASPxButton ID="btn_save" runat="server" Style="float: right;" ImageSpacing="3px" Text="SAVE CHANGES" Image-Url="~/Images/save.png" OnClick="btn_SaveRequest_Click">
            ...
            <dx:ASPxPanel ID="CompanyPanel" runat="server" ClientInstanceName="CompanyPanel" Width="100%" CssClass="centered">
                <PanelCollection>
                    <dx:PanelContent>
                        <dx:ASPxPageControl ID="CompanyDatapc" Width="100%" runat="server" ActiveTabIndex="0" EnableHierarchyRecreation="True" Enabled="false">
                            <TabPages>
                                                                ...
                                                                <LayoutItemNestedControlCollection>
                                                                    <dx:LayoutItemNestedControlContainer>
                                                                        <dx:ASPxTextBox runat="server" ID="tbx_CompanyABN" ClientInstanceName="tbx_CompanyABN">
                                                                            <ValidationSettings Display="Dynamic"  RegularExpression-ValidationExpression=".{11}" RegularExpression-ErrorText="ABN must have 11 characters in lenght" RequiredField-IsRequired="true" ErrorDisplayMode="Text" SetFocusOnError="true" ErrorTextPosition="Bottom" ErrorFrameStyle-Wrap="true"/>
                                                                        </dx:ASPxTextBox>
                                                                    </dx:LayoutItemNestedControlContainer>
                                                                </LayoutItemNestedControlCollection>
                                                            </dx:LayoutItem>
                                                                ...
                                                                <LayoutItemNestedControlCollection>
                                                                    <dx:LayoutItemNestedControlContainer>
                                                                        <table>
                                                                            <tr>
                                                                                <td>
                                                                                    <dx:ASPxLabel ID="AspxLabel7" runat="server" Text="Has your company had any contracts terminated over the past \n 3 years for poor performance or corrective actions?"></dx:ASPxLabel>
                                                                                </td>
                                                                                <td>
                                                            ...
                                                            <dx:LayoutItemNestedControlContainer>
                                                                ...
                                                                <dx:ASPxGridView ID="CompanyTradeSkills" KeyFieldName="TRADE_ID" ClientInstanceName="CompanyTradeSkills" runat="server" Width="100%" DataSourceID="sqlDS_TradeSkills">
                                                                    <Columns>
                                                                        ...
                                                                        <dx:GridViewDataTextColumn Caption="Image" ShowInCustomizationForm="True" VisibleIndex="4">
                                                                            <DataItemTemplate>
                                                                                <asp:Image ID="Image1" runat="server" ImageUrl='<%#  Eval("GUID") %>' Height="120px" Width="100px" />
                                                                                <a id="clickElement" target="_blank" href='<%#  Eval("GUID1") %>'>Download</a>
                                                                            </DataItemTemplate>
                                                                        </dx:GridViewDataTextColumn>
                                                                ...
                                                                <table>
                                                                    <tr>
                                                                        <td>
                                                                            ...
                                                                            <a id="lnk_viewswmsdoc" runat="server" target="_blank" href='d'>Download</a>
                                                                        </td>
                                                ...
                                                <Columns>
                                                   ...
                                                   <dx:GridViewDataTextColumn  ShowInCustomizationForm="True" Caption="TELEPHONES" >
                                                    ...
                                                    <dx:GridViewDataTextColumn  ShowInCustomizationForm="True" Caption="INDUCTION CARD" >
                                                       <DataItemTemplate>
                                                          Number  : <%#  Eval("INDUCTION_CARD_NUMBER") %> <br/>
                                                    ...
                                                    <dx:GridViewDataTextColumn  ShowInCustomizationForm="True" Caption="POLICE CHECK" >
                                                       <DataItemTemplate>
                                                          Number  : <%#  Eval("POLICECHECK_REFERENCE") %> <br/>
