<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WhatToDoDispute.aspx.cs" Inherits="SubcontractorPortal.WOrders.WhatToDoDispute" %>
...
<div id="PopupWindowClient">
                             ...
                             <tr>
                                <td>                            
                                    <table cellpadding="5" cellspacing="5" id="WHSTable" runat="server"  align="left"  style="display: block">
                                        <tr>
                                            <td colspan="2">1. Send Subcontractor WHS Statement to Maincom
                            ...
                            <tr>
                                <td>
                                    <table cellpadding="5" cellspacing="5" id="Table1" runat="server"  align="left"  style="display: block">
                                            <tr>
                                                <td>2. Upload Completion Certificate:
                             ...
                             <tr>
                                 <td>
                                     <asp:Panel ID="CompliancePanel" runat="server">
                                        <table cellpadding="5" cellspacing="5"  align="left"  style="display: block">
                                            <tr>
                                                <td>3. Upload Compliance Certificate <span id="ComplianceSpan">(If Required)</span>
                             ...
                             <tr>
                                 <td>
                                     <asp:Panel ID="Panel2" runat="server">
                                        <table cellpadding="5" cellspacing="5"  align="left"  style="display: block">
                                            <tr>
                                                <td>4. Upload Photos (If Required)
                             ...
                             <tr>
                                 <td>
                                     <asp:Panel ID="Panel3" runat="server">
                                        <table cellpadding="5" cellspacing="5"  align="left"  style="display: block">
                                            <tr>
                                                <td>5. Upload Receipts (If Required)
	...
	CompleteWO();
                ...
                <dx:TabPage Text="Dispute Reason">
                    <ContentCollection>
                        <dx:ContentControl ID="ContentControl1" runat="server" >
                            <table cellpadding="5" cellspacing="5">
                                <tr>                                    
                                    <th>Message from Maincom:</th>                                    
                                </tr>
                                <tr>
                                    <td>
                                        <dx:ASPxLabel ID="DisputeMessage" runat="server"></dx:ASPxLabel>
                                    </td>
