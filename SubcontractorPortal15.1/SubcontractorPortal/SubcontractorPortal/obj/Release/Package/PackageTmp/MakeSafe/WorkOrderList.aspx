<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WorkOrderList.aspx.cs" Inherits="SubcontractorPortal.MakeSafe.WorkOrderList" %>
...
<body>
	...
	window.location.replace('/MakeSafe/WorkOrderView.aspx?WOID=' + key);
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DataConnectionString %>" SelectCommand="Subcontractor_List_MakeSafe_WOs_By_Status" SelectCommandType="StoredProcedure">
            <SelectParameters>
