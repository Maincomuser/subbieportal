<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Step5.aspx.cs" Inherits="SubcontractorPortal.Registration.Step5" %>
...
<div id="PopupWindow">
    ...
    <table width="100%" cellspacing="7">
        <tr>
            <td class="LMFont" align="center">                    
                        Referees (this may be a Maincom Contact or External):
    ...
    <table width="100%" cellspacing="7">
        ...
        <tr>
            ...
            <td class="LMFont">
                                <dx:ASPxTextBox ID="JobPerMonth" ClientInstanceName="JobPerMonth" runat="server" Border-BorderStyle="Solid" Border-BorderWidth="2px" Height="30px" Width="250px" Border-BorderColor="Black" Font-Size="20px">
