<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Step4.aspx.cs" Inherits="SubcontractorPortal.Registration.Step4" %>
...
<body style="background-color:#009FCE;">
    ...
    <script type="text/javascript">
        ...
        function CheckForm() {
            window.location.replace('OtherConditions.aspx');
        }
    ...
    <form id="form1" runat="server">
        ...
        <table align="center">
            ...
            <tr>
                ...
                <td class="LMFontTop">                    
                    11 Rules you must comply when working on site:</td>
            </tr>
    ...
    <table width="100%" cellspacing="15">
        <tr>
            <td class="LMFont">                    
                        1. You MUST NOT use words of offensive nature (whether written or spoken) at Maincom work site.                     
            </td>
        </tr>
        <tr>
            <td class="LMFont">                    
                        2. You MUST NOT SMOKE or light fires on or near a Maincom work site.
            </td>
        </tr>

        <tr>
            <td class="LMFont">                    
                        3. You MUST NOT use physical behaviour of a sexual or intimidating manner on or near a Maincom work site.
            </td>
        </tr>
        <tr>
            <td class="LMFont">                    
                        4. You MUST NOT use clients power, gas or water without permission.
            </td>
        </tr>
        <tr>
            <td class="LMFont">                    
                        5. You MUST NOT use the clients toilet, wash basins, stoves, hot water, telephone or eat food in clients home without prior permission.
            </td>
        </tr>
        <tr>
            <td class="LMFont">                    
                        6. You MUST clean all rubbish on completion of works.
            </td>
        </tr>
        <tr>
            <td class="LMFont">                    
                        7. You MUST NOT work alone unless permission granted or notification to a The Maincom Group Supervisor has been given for all high risk work.
            </td>
        </tr>
        <tr>
            <td class="LMFont">                    
                        8. You MUST NOT work on any site without adult supervision to any child under the age of 18, or work within the vicinity of children if in a uncontrolled environment and without a Working with Children ID card.
            </td>
        </tr>
        <tr>
            <td class="LMFont">                    
                        9. You MUST NOT work within the vicinity of children if in an uncontrolled environment.
            </td>
        </tr>
        <tr>
            <td class="LMFont">                    
                        10. You MUST always make prior contact to the homeoner /representative prior to attending (24Hrs before you are attending), and introduce yourself and why you are attending.
            </td>
        </tr>
        <tr>
            <td class="LMFont">                    
                        11. You MUST report any on-site incidents to a Maincom representative ASAP.
            </td>
        </tr>
